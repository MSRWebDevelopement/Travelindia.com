...
public class cprof extends HttpServlet {
...
"		</div>\n" +
    ...
    "						<div class=\"col-md-4 col-md-push-1 animate-box\" data-animate-effect=\"fadeInRight\">\n");
                ...
                out.println("<div class='form-wrap'><div class='tab'><div class='tab-content'><div class='tab-content-inner active' data-content='signup'><h3>Conductor Details</h3><form method='post'><div class='row form-group'><div class='col-md-12'><label for='activities'>First Name</label><input type='text' class='form-control' value='"+rs.getString("c_fname")+"' readonly required></div><div class='col-md-12'><label for='activities'>Last Name</label><input type='text' class='form-control' value='"+rs.getString("c_lname")+"' readonly required></div></div><div class='row form-group'><div class='col-md-12'><label for='gender'>Gender</label><input type='text' class='form-control' value='"+rs.getString("c_gen")+"' readonly required></div></div><div class='row form-group'><div class='col-md-12'><label for='gmail'>Gmail</label><input type='text' class='form-control' value='"+rs.getString("c_gmail")+"' readonly required></div></div><div class='row form-group'><div class='col-md-12'><label for='nost'>Mobile</label><input type='text' class='form-control' value='"+rs.getString("c_phone")+"' readonly required></div></div>      <div class='row form-group'><div  class='col-md-12'><label for='activities'>Password</label><input type='text' class='form-control' value='"+rs.getString("c_pass")+"' readonly required></div></div></form></div></div></div></div>");
                out.println(
    "                                            \n" +
